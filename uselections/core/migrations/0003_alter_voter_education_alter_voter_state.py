# Generated by Django 5.0.6 on 2024-07-22 13:24
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0002_voter_candidate_votes'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='voter',
            name='education',
            field=models.CharField(choices=[('N', 'None'), ('HS', 'High school'), ('C', 'College')], max_length=20),
        ),
        migrations.AlterField(
            model_name='voter',
            name='state',
